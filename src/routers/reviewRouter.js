...
let rev5 = product.productReviews.filter((rev)=>rev.rate==5).length 
    let rev4 = product.productReviews.filter((rev)=>rev.rate==4).length * 0.8
    let rev3 = product.productReviews.filter((rev)=>rev.rate==3).length * 0.6
    let rev2 = product.productReviews.filter((rev)=>rev.rate==2).length * 0.4
    let rev1 = product.productReviews.filter((rev)=>rev.rate==1).length * 0.2
    
    let revsCount = product.productReviews.length
